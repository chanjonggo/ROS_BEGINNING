...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlesim_msgs
has_buffer_fields_TeleportRelative_Request()
{
  return has_buffer_fields_turtlesim_msgs__srv__TeleportRelative_Request();
}
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlesim_msgs
has_buffer_fields_TeleportRelative_Response()
{
  return has_buffer_fields_turtlesim_msgs__srv__TeleportRelative_Response();
}
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  try {
    ...
    // Member: request
    {
      ...
      cdr << static_cast<uint32_t>(size);
      for (size_t i = 0; i < size; i++) {
        turtlesim_msgs::srv::typesupport_fastrtps_cpp::cdr_serialize_with_endpoint(
          ros_message.request[i],
          cdr, endpoint_info, serialization_context);
      }
    }
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      turtlesim_msgs::srv::typesupport_fastrtps_cpp::cdr_deserialize_with_endpoint(
        cdr,
        ros_message.request[i],
        endpoint_info,
        serialization_context);
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlesim_msgs
has_buffer_fields_TeleportRelative_Event()
{
  return has_buffer_fields_turtlesim_msgs__srv__TeleportRelative_Event();
}
