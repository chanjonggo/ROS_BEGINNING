...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlesim_msgs
has_buffer_fields_Spawn_Request()
{
  return has_buffer_fields_turtlesim_msgs__srv__Spawn_Request();
}
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlesim_msgs
has_buffer_fields_Spawn_Response()
{
  return has_buffer_fields_turtlesim_msgs__srv__Spawn_Response();
}
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlesim_msgs
has_buffer_fields_Spawn_Event()
{
  return has_buffer_fields_turtlesim_msgs__srv__Spawn_Event();
}
