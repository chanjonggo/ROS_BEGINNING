...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
bool cdr_serialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Request(
  const turtlesim_msgs__srv__TeleportRelative_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
bool cdr_deserialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Request(
  eprosima::fastcdr::Cdr & cdr,
  turtlesim_msgs__srv__TeleportRelative_Request * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
static bool _TeleportRelative_Request__cdr_serialize_with_endpoint(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  const turtlesim_msgs__srv__TeleportRelative_Request * ros_message =
    static_cast<const turtlesim_msgs__srv__TeleportRelative_Request *>(untyped_ros_message);
  return cdr_serialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Request(
    ros_message, cdr, endpoint_info, serialization_context);
}

static bool _TeleportRelative_Request__cdr_deserialize_with_endpoint(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  turtlesim_msgs__srv__TeleportRelative_Request * ros_message =
    static_cast<turtlesim_msgs__srv__TeleportRelative_Request *>(untyped_ros_message);
  return cdr_deserialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Request(
    cdr, ros_message, endpoint_info, serialization_context);
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
bool has_buffer_fields_turtlesim_msgs__srv__TeleportRelative_Request()
{
  return
    false;
}
...
static message_type_support_callbacks_t __callbacks_TeleportRelative_Request = {
  ...
  nullptr,
  has_buffer_fields_turtlesim_msgs__srv__TeleportRelative_Request(),
  _TeleportRelative_Request__cdr_serialize_with_endpoint,
  _TeleportRelative_Request__cdr_deserialize_with_endpoint
};
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
bool cdr_serialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Response(
  const turtlesim_msgs__srv__TeleportRelative_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
bool cdr_deserialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Response(
  eprosima::fastcdr::Cdr & cdr,
  turtlesim_msgs__srv__TeleportRelative_Response * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
static bool _TeleportRelative_Response__cdr_serialize_with_endpoint(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  const turtlesim_msgs__srv__TeleportRelative_Response * ros_message =
    static_cast<const turtlesim_msgs__srv__TeleportRelative_Response *>(untyped_ros_message);
  return cdr_serialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Response(
    ros_message, cdr, endpoint_info, serialization_context);
}

static bool _TeleportRelative_Response__cdr_deserialize_with_endpoint(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  turtlesim_msgs__srv__TeleportRelative_Response * ros_message =
    static_cast<turtlesim_msgs__srv__TeleportRelative_Response *>(untyped_ros_message);
  return cdr_deserialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Response(
    cdr, ros_message, endpoint_info, serialization_context);
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
bool has_buffer_fields_turtlesim_msgs__srv__TeleportRelative_Response()
{
  return
    false;
}
...
static message_type_support_callbacks_t __callbacks_TeleportRelative_Response = {
  ...
  nullptr,
  has_buffer_fields_turtlesim_msgs__srv__TeleportRelative_Response(),
  _TeleportRelative_Response__cdr_serialize_with_endpoint,
  _TeleportRelative_Response__cdr_deserialize_with_endpoint
};
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
bool cdr_serialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Event(
  const turtlesim_msgs__srv__TeleportRelative_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Request(
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Response(
        &array_ptr[i], cdr, endpoint_info, serialization_context);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
bool cdr_deserialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Event(
  eprosima::fastcdr::Cdr & cdr,
  turtlesim_msgs__srv__TeleportRelative_Event * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: request
  {
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Request(cdr, &array_ptr[i], endpoint_info, serialization_context);
    }
  }
  ...
  // Field name: response
  {
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Response(cdr, &array_ptr[i], endpoint_info, serialization_context);
    }
  }
...
static bool _TeleportRelative_Event__cdr_serialize_with_endpoint(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  const turtlesim_msgs__srv__TeleportRelative_Event * ros_message =
    static_cast<const turtlesim_msgs__srv__TeleportRelative_Event *>(untyped_ros_message);
  return cdr_serialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Event(
    ros_message, cdr, endpoint_info, serialization_context);
}

static bool _TeleportRelative_Event__cdr_deserialize_with_endpoint(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  turtlesim_msgs__srv__TeleportRelative_Event * ros_message =
    static_cast<turtlesim_msgs__srv__TeleportRelative_Event *>(untyped_ros_message);
  return cdr_deserialize_with_endpoint_turtlesim_msgs__srv__TeleportRelative_Event(
    cdr, ros_message, endpoint_info, serialization_context);
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
bool has_buffer_fields_turtlesim_msgs__srv__TeleportRelative_Event()
{
  return
...
static message_type_support_callbacks_t __callbacks_TeleportRelative_Event = {
  ...
  nullptr,
  has_buffer_fields_turtlesim_msgs__srv__TeleportRelative_Event(),
  _TeleportRelative_Event__cdr_serialize_with_endpoint,
  _TeleportRelative_Event__cdr_deserialize_with_endpoint
};
